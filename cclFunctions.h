...
extern "C" bool cclSolveCCLShared(sCudaBuffer2D outLabelsBuf, sCudaBuffer2D inSegBuf, int threadsX, int threadsY, int imgWidth, int imgHeight, int dataWidth, int log2DataWidth);
extern "C" bool cclMergeEquivalenceTrees(sCudaBuffer2D inOutLabelsBuf, sCudaBuffer2D inSegBuf, int* dChanged, int threadsX, int threadsY, int imgWidth, int imgHeight, int dataWidth, int log2DataWidth, int subBlockSize);
